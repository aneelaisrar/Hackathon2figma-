      ...
      <div className="w-full max-w-screen-xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center md:text-left">
            <h3 className="text-[#0a0f27] text-3xl font-bold mb-4">20% Discount Of All Products</h3>
          ...
          <div className="relative flex justify-center">
            <div
              className="absolute inset-0 bg-blue-100 w-[400px] h-[400px] -z-10 rounded-full"
              style={{ margin: "auto" }}
            ></div>
            <Image
              src="/sofa3.png"
